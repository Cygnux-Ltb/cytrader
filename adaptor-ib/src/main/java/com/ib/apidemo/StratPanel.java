...
public class StratPanel extends StackPanel implements IHistoricalDataHandler, IRealTimeBarHandler {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4838843143186784313L;
	...
	StratPanel() {
		...
		HtmlButton start = new HtmlButton("Start") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2600435444224551417L;
		...
		HtmlButton stop = new HtmlButton("Stop") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 8466531609471712571L;
	...
	public void realtimeBar(Bar bar) {
		if (!m_req) {
			...
			ApiDemo.INSTANCE.controller().reqHistoricalData(m_contract, date, duration, queryLength.m_unit, barSize,
					WhatToShow.TRADES, false, this);
			m_req = true;
		}
		addBar(bar);
		m_chart.repaint();
	...
	class HPanel extends HorzPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -948097138821141125L;

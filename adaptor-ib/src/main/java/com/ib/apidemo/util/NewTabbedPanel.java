...
public class NewTabbedPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 857676585357850403L;
	...
	public void addTab(final String titleIn, final JComponent comp, boolean select, boolean canClose) {
		final String title = m_map.containsKey(titleIn) ? titleIn + " " + m_count++ : titleIn;
	...
	public static abstract class NewTabPanel extends JPanel implements INewTab {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2565386463077777937L;
	}
	...
	class But extends HtmlButton {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2398163906815781623L;

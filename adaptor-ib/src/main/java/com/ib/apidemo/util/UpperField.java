...
public class UpperField extends JTextField {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7366024030971640001L;
	...
	public UpperField(String s, int i) {
		...
		setDocument(new PlainDocument() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -3289109935720734961L;
	...
	public double getDouble() {
		try {
			...
			return str == null || str.length() == 0 ? m_dval : Double.parseDouble(super.getText().trim());
		} catch (Exception e) {
			return 0;
		}
	}
	...
	public int getInt() {
		try {
			String str = super.getText();
			return str == null || str.length() == 0 ? m_ival : Integer.parseInt(super.getText().trim());
		} catch (Exception e) {
			return 0;
		}
	}

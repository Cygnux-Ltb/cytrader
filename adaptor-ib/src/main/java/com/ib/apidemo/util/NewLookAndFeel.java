...
public class NewLookAndFeel extends MetalLookAndFeel {
	...
	protected void initClassDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = new Object[] { "CheckBoxUI", NewCheckUI.class.getName(), "LabelUI",
				NewLabelUI.class.getName(), "ComboBoxUI", NewComboUI.class.getName(), "TableUI",
				NewTableUI.class.getName() };

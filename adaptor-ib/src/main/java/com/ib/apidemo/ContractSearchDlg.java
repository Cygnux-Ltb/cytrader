...
public class ContractSearchDlg extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8028237554342420068L;
	...
	private ArrayList<ContractDetails> lookupContract() {
		// return com.ib.client.Util.lookupContract(ApiDemo.INSTANCE.controller(),
		// m_contract);
	...
	public ContractSearchDlg(int conId, String exchange, ContractLookuper lookuper) {
		...
		buttons.add(new HtmlButton("search") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 8024702688734252958L;
	...
	public String refContract() {
		...
		return selectedContract().symbol() + " " + selectedContract().exchange() + " " + selectedContract().secType()

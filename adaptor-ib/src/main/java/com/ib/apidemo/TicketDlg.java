...
public class TicketDlg extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2117257966194317205L;
	...
	public TicketDlg(Contract contract, Order order) {
		...
		HtmlButton transmitOrder = new HtmlButton("Transmit Order") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 7227896265400677339L;
		...
		HtmlButton checkMargin = new HtmlButton("Check Margin") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -4573706520812011256L;
		...
		HtmlButton close = new HtmlButton("Close") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 1281943889448553149L;
	...
	protected void displayMargin(OrderState orderState) {
		String str = String.format("Equity with loan: %s\n\nInitial margin: %s\nMaintenance margin: %s\n",
				fmt(Double.parseDouble(orderState.equityWithLoan())), fmt(Double.parseDouble(orderState.initMargin())),
	...
	class OrderPanel extends VerticalPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3465526634759590162L;
	...
	class AdvisorTicketPanel extends VerticalPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3178203047867616115L;
	...
	class MiscTicketPanel extends StackPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8092417277324139747L;
	...
	class VolatilityTicketPanel extends VerticalPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -9068813411884191899L;
		...
		final TCombo<ReferencePriceType> m_referencePriceType = new TCombo<ReferencePriceType>(
	...
	/**
	 * This panel edits all ComboParam values except for Non-Guaranteed. That one
	 * goes on main panel because it applies to all combo orders.
	 */
	class ComboTicketPanel extends VerticalPanel {
		/**
		 * 
		 */
		private static final long serialVersionUID = -2460835841965980288L;
	...
	class AlgoPanel extends VerticalPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8744800043077058420L;
	...
	class ScalePanel extends VerticalPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 5475394843779873809L;

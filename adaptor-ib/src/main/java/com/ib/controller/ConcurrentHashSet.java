...
public class ConcurrentHashSet<Key> extends AbstractSet<Key> {
	...
	/**
	 * use write concurrency level 1 (last param) to decrease memory consumption by
	 * ConcurrentHashMap
	 */
	private ConcurrentHashMap<Key, Object> m_map = new ConcurrentHashMap<Key, Object>(16, 0.75f, 1);

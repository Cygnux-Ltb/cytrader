 ...
 */
@NotThreadSafe
public final class PositionKeeper2 implements Serializable, Formattable<String> {
	...
	public static int getCurrentSubAccountPositionLimit(int subAccountId, Instrument instrument,
		...
		switch (direction) {
		case Long:
			return SubAccountInstrumentLongLimit.get(key) - currentQty;
		case Short:
			return SubAccountInstrumentShortLimit.get(key) - currentQty;
		default:
			return 0;
		}
	}
	...
	public static int getCurrentAccountPositionLimit(int accountId, Instrument instrument, TrdDirection direction) {
		...
		switch (direction) {
		case Long:
			return AccountInstrumentLongLimit.get(key) - currentQty;
		case Short:
			return AccountInstrumentShortLimit.get(key) - currentQty;
		default:
			return 0;
		}
	}

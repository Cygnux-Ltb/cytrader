...
public class JournalingTestsModule {
	...
	public static void journalingTestImpl(final PerformanceConfiguration performanceConfiguration,
		...
		for (int iteration = 0; iteration < iterations; iteration++) {
			...
			final InitialStateConfiguration firstStartConfig = InitialStateConfiguration
					.cleanStartJournaling(exchangeId);

			try (final ExchangeTestContainer container = ExchangeTestContainer.create(performanceConfiguration,
					firstStartConfig, SerializationConfiguration.DISK_JOURNALING)) {
			...
			final InitialStateConfiguration fromSnapshotConfig = InitialStateConfiguration
			...
			try (final ExchangeTestContainer recreatedContainer = ExchangeTestContainer.create(performanceConfiguration,
					fromSnapshotConfig, SerializationConfiguration.DISK_JOURNALING)) {

...
public class NasdaqReader {
	...
	public void test() throws Exception {
		...
		try (final ExchangeTestContainer container = ExchangeTestContainer.create(perfCfg, initStateCfg,
...
//            counters.forEach((k, v) -> log.debug("{} = {}", k, v));
			log.info("TOTAL: {} troughput = {} TPS", totalSymbolMessages,
					totalSymbolMessages * 1_000_000_000L / executionTime.getResultNs().join());

...
public class MarketDataSubscribe extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @return A new MarketDataSubscribe RecordBuilder
   */
  public static io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder newBuilder(io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder other) {
    if (other == null) {
      return new io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder();
    } else {
   ...
   * @return A new MarketDataSubscribe RecordBuilder
   */
  public static io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder newBuilder(io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe other) {
    if (other == null) {
      return new io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder();
    } else {
      return new io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataSubscribe>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setStartTradingDay(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setEndTradingDay(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mercury.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setInstrumentIdList(java.util.List<java.lang.String> value) {

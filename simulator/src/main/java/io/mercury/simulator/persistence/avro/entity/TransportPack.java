...
public class TransportPack extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8321844019930159361L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TransportPack\",\"namespace\":\"io.mercury.simulator.persistence.avro.entity\",\"fields\":[{\"name\":\"title\",\"type\":{\"type\":\"enum\",\"name\":\"PackTitle\",\"symbols\":[\"T_MarketDataSubscribe\",\"T_MarketDataLevel1\",\"T_Order\",\"T_Next\"]}},{\"name\":\"content\",\"type\":\"bytes\"}]}");
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: title = (io.mercury.simulator.persistence.avro.entity.PackTitle)value$; break;
   ...
   * @return A new TransportPack RecordBuilder
   */
  public static io.mercury.simulator.persistence.avro.entity.TransportPack.Builder newBuilder(io.mercury.simulator.persistence.avro.entity.TransportPack.Builder other) {
    if (other == null) {
      return new io.mercury.simulator.persistence.avro.entity.TransportPack.Builder();
    } else {
   ...
   * @return A new TransportPack RecordBuilder
   */
  public static io.mercury.simulator.persistence.avro.entity.TransportPack.Builder newBuilder(io.mercury.simulator.persistence.avro.entity.TransportPack other) {
    if (other == null) {
      return new io.mercury.simulator.persistence.avro.entity.TransportPack.Builder();
    } else {
      return new io.mercury.simulator.persistence.avro.entity.TransportPack.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransportPack>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mercury.simulator.persistence.avro.entity.TransportPack.Builder setTitle(io.mercury.simulator.persistence.avro.entity.PackTitle value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mercury.simulator.persistence.avro.entity.TransportPack.Builder setContent(java.nio.ByteBuffer value) {
    ...
    public TransportPack build() {
      try {
        ...
        record.title = fieldSetFlags()[0] ? this.title : (io.mercury.simulator.persistence.avro.entity.PackTitle) defaultValue(fields()[0]);

...
public class MarketDataSubscribe extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: startTradingDay = value$ != null ? value$.toString() : null; break;
    case 2: endTradingDay = value$ != null ? value$.toString() : null; break;
  ...
  /**
   * Gets the value of the 'uniqueId' field as an Optional&lt;java.lang.Integer&gt;.
  ...
  /**
   * Gets the value of the 'startTradingDay' field as an Optional&lt;java.lang.String&gt;.
  ...
  /**
   * Gets the value of the 'endTradingDay' field as an Optional&lt;java.lang.String&gt;.
   * @return The value wrapped in an Optional&lt;java.lang.String&gt;.
   */
  ...
  /**
   * Gets the value of the 'instrumentIdList' field as an Optional&lt;java.util.List<java.lang.String>&gt;.
   ...
   */
  public static io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder newBuilder() {
    return new io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder();
  }
   ...
   * @return A new MarketDataSubscribe RecordBuilder
   */
  public static io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder newBuilder(io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder other) {
    if (other == null) {
      return new io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder();
    } else {
      return new io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder(other);
    }
  }
   ...
   * @return A new MarketDataSubscribe RecordBuilder
   */
  public static io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder newBuilder(io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe other) {
    if (other == null) {
      return new io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder();
    } else {
      return new io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataSubscribe>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.uniqueId)) {
        this.uniqueId = data().deepCopy(fields()[0].schema(), other.uniqueId);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setUniqueId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder clearUniqueId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setStartTradingDay(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder clearStartTradingDay() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setEndTradingDay(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder clearEndTradingDay() {
      endTradingDay = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder setInstrumentIdList(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnus.simulator.persistence.avro.entity.MarketDataSubscribe.Builder clearInstrumentIdList() {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<java.lang.String>((int)size0, SCHEMA$.getField("instrumentIdList").schema());

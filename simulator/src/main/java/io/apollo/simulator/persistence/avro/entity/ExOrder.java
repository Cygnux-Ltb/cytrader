...
public class ExOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @return A new ExOrder RecordBuilder
   */
  public static io.apollo.simulator.persistence.avro.entity.ExOrder.Builder newBuilder(io.apollo.simulator.persistence.avro.entity.ExOrder.Builder other) {
    if (other == null) {
      return new io.apollo.simulator.persistence.avro.entity.ExOrder.Builder();
    } else {
   ...
   * @return A new ExOrder RecordBuilder
   */
  public static io.apollo.simulator.persistence.avro.entity.ExOrder.Builder newBuilder(io.apollo.simulator.persistence.avro.entity.ExOrder other) {
    if (other == null) {
      return new io.apollo.simulator.persistence.avro.entity.ExOrder.Builder();
    } else {
      return new io.apollo.simulator.persistence.avro.entity.ExOrder.Builder(other);

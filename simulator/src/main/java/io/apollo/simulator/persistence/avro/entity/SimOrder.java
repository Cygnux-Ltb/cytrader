...
public class SimOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @return A new SimOrder RecordBuilder
   */
  public static io.apollo.simulator.persistence.avro.entity.SimOrder.Builder newBuilder(io.apollo.simulator.persistence.avro.entity.SimOrder.Builder other) {
    if (other == null) {
      return new io.apollo.simulator.persistence.avro.entity.SimOrder.Builder();
    } else {
   ...
   * @return A new SimOrder RecordBuilder
   */
  public static io.apollo.simulator.persistence.avro.entity.SimOrder.Builder newBuilder(io.apollo.simulator.persistence.avro.entity.SimOrder other) {
    if (other == null) {
      return new io.apollo.simulator.persistence.avro.entity.SimOrder.Builder();
    } else {
      return new io.apollo.simulator.persistence.avro.entity.SimOrder.Builder(other);

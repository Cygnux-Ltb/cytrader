...
public class TransportPack extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: title = (io.apollo.simulator.persistence.avro.entity.PackTitle)value$; break;
  ...
  /**
   * Gets the value of the 'title' field as an Optional&lt;io.apollo.simulator.persistence.avro.entity.PackTitle&gt;.
   * @return The value wrapped in an Optional&lt;io.apollo.simulator.persistence.avro.entity.PackTitle&gt;.
   */
   ...
   * @return A new TransportPack RecordBuilder
   */
  public static io.apollo.simulator.persistence.avro.entity.TransportPack.Builder newBuilder(io.apollo.simulator.persistence.avro.entity.TransportPack.Builder other) {
    if (other == null) {
      return new io.apollo.simulator.persistence.avro.entity.TransportPack.Builder();
    } else {
   ...
   * @return A new TransportPack RecordBuilder
   */
  public static io.apollo.simulator.persistence.avro.entity.TransportPack.Builder newBuilder(io.apollo.simulator.persistence.avro.entity.TransportPack other) {
    if (other == null) {
      return new io.apollo.simulator.persistence.avro.entity.TransportPack.Builder();
    } else {
      return new io.apollo.simulator.persistence.avro.entity.TransportPack.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransportPack>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.apollo.simulator.persistence.avro.entity.TransportPack.Builder setTitle(io.apollo.simulator.persistence.avro.entity.PackTitle value) {
    ...
    public TransportPack build() {
      try {
        ...
        record.title = fieldSetFlags()[0] ? this.title : (io.apollo.simulator.persistence.avro.entity.PackTitle) defaultValue(fields()[0]);

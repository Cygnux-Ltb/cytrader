...
public class Order extends org.apache.avro.specific.SpecificRecordBase
	 ...
	 */
	public Order(java.lang.Integer strategyId, java.lang.String brokerId, java.lang.String investorId,
	 ...
	 */
	public static io.mercury.simulator.persistence.avro.entity.Order.Builder newBuilder(
			io.mercury.simulator.persistence.avro.entity.Order.Builder other) {
		if (other == null) {
			return new io.mercury.simulator.persistence.avro.entity.Order.Builder();
		} else {
	 ...
	 */
	public static io.mercury.simulator.persistence.avro.entity.Order.Builder newBuilder(
			io.mercury.simulator.persistence.avro.entity.Order other) {
		if (other == null) {
			return new io.mercury.simulator.persistence.avro.entity.Order.Builder();
		} else {
			return new io.mercury.simulator.persistence.avro.entity.Order.Builder(other);
